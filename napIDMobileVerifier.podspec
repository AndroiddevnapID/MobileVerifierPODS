...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.1'
  s.summary          = 'Its a circular image view'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AndroiddevnapID/MobileVerifierPODS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AndroiddevnapID' => 'mani@napid.co' }
  s.source           = { :git => 'https://github.com/AndroiddevnapID/MobileVerifierPODS.git', :tag => s.version.to_s }
